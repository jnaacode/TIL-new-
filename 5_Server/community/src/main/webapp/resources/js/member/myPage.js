...
function infoValidate(){
    ...
    const reqExp1 = /^[a-zA-Z가-힣0-9]{2,10}$/; // 닉네임 정규식
    
    // const reqExp2 = /^0[0-9]{1,2}[0-9]{7,8}$/; // 전화번호 정규식
    const reqExp2 = /^0(1[01679]|2|[3-6][1-5]|70)\d{3,4}\d{4}$/; // 전화번호 정규식

    // 010 011 016 017 019
    // 02 031 032 041 041 051 052
    // 070
    ...
    if(!reqExp1.test(memberNickname.value)){ // 유효하지 않은 경우
    ...
    if(!reqExp2.test(memberTel.value)){
...
function changePwValidate(){
    ...
    return true; // 위 조건을 모두 수행하지 않는 경우
