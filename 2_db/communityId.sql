...
CREATE USER community_lys IDENTIFIED BY community1234;

ALTER USER community_lys DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;

GRANT CONNECT, RESOURCE, CREATE VIEW TO community_lys;


ALTER SESSION SET "_ORACLE_SCRIPT" = TRUE;

CREATE USER semitest IDENTIFIED BY semitest1234;

ALTER USER semitest DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;

GRANT CONNECT, RESOURCE, CREATE VIEW TO semitest;


ALTER SESSION SET "_ORACLE_SCRIPT" = TRUE;

CREATE USER semitest3 IDENTIFIED BY semitest1234;

ALTER USER semitest3 DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;

GRANT CONNECT, RESOURCE, CREATE VIEW TO semitest3;
...
ALTER TABLE BOARD
ADD CONSTRAINT "FK_BOARD_DB" -- 제약 조건명 지정
...
-- 댓글 작성
INSERT INTO REPLY 
VALUES(SEQ_RNO.NEXTVAL, '댓글', DEFAULT, DEFAULT, '멤버넘버', '보드넘버');
