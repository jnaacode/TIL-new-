                ...
                <%-- header.jsp 추가(포함) --%>
                    ...
                    <section class="content">
                        <section class="content-1">
                            ...
                            emial : <input type="text" id="inputEmail">
                        ...
                        <section class="content-2">
                            ...
                            <c:choose>
                                <%-- c:choose 내부에는 c:when, c:otherwise, jsp 주석만 작성 가능 c:when, c:otherwise 내부에는 다른 코드 작성
                                    가능! --%>
                                            ...
                                            <form action="/member/login" method="POST" id="loginFrm">
                                                ...
                                                <label>
                                                    ...
                                                    <%-- <c:if test="${empty cookie.saveId.value}">
                                                        ...
                                                        <c:if test="${!empty cookie.saveId.value}">
                                                            <%-- 쿠키에 저장된 이메일이 있으면 save 변수 선언 -> page scope(페이지 내에서 사용
                                                                가능, if문이 끝나도 가능!)
                                                                --%>
                                            ...
                                            <c:otherwise>
                                                <article class="login-area">
                                                    ...
                                                    <div class="my-info">
                                                        <div>
                                                            <a href="/myPage/info"
                                                                id="nickname">${sessionScope.loginMember.memberNickname}</a>
